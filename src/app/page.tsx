    ...
    <main className="w-full">
      <section className="p-8 h-[90vh] md:w-2/3 mx-auto text-center w-full flex flex-col items-center justify-center">
        ...
        <p className="text-gray-400 mb-12 md:text-base lg:text-xl leading-loose w-[70%]">
          This application is an online invoicing software that helps you craft
          and print professional invoices for your customers for free! Get
          started by signing in with your email or Google account.
        </p>
        <Link
          href="/dashboard"
